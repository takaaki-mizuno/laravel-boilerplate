...
@section('content')
    ...
    @if( $isNew )
        <form action="{!! action('Admin\ImageController@store') !!}" method="POST" enctype="multipart/form-data">
    @else
        <form action="{!! action('Admin\ImageController@update', [$image->id]) !!}" method="POST" enctype="multipart/form-data">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group @if ($errors->has('entity_id')) has-error @endif">
                        ...
                        <input type="text" class="form-control" id="entity_id" name="entity_id" value="{{ old('entity_id') ? old('entity_id') : $image->entity_id }}">
                    </div>
